...
/*
 	사원들의 정보와 관련된 데이터베이스 작업을 할 때 필요한 질의명령을 모아놓았다가
 	해당 질의명령을 요구하면 내보내는 기능을 가진 클래스
 */
public class EmpSQL {
	//코드변수
	...
	public String getSQL(int code) {
		/*
		 	...
		 	질의명령은 한 행으로 작성하면 가족성에 문제가 있기 때문에
		 	보통 줄바꿈, 들여쓰기를 이용해서 작성한다.
		 	여기서도 이 방법을 사용할 것인데
		 	분자열을 결합연산 할 때마다 힙영역에 새로운 객체를 만들게 된다는 문제점을
		 	피할 목적으로 StringBuffer 를 사용해서 처리하기로 하자.
