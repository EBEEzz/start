...
public class Test09 {
	...
	public Test09() {
		...
		MyThread01 sy = new MyThread01();	//New Born 상태
		MyThread02 sr = new MyThread02();	//New Born 상태
...
/*
	원래는 스레드 프로그램 역시 다른 파일 클래스에 만들어야 하는데
	지금은 간단한 테스트이므로 하나의 클래스내에서 두개의 스레드 프로그램을 만들어보자.
 */

class MyThread01 extends Thread {
	//이 클래스 내에는 변수나 다른 함수들을 만들 수 있지만 여기서는 테스트만 해보기로 한다.
	@Override
	public void run() {
		//나는 이 프로그램에서 박소연씨가 코딩을 1000개 하도록 하게 할 것이다.
